...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0128", superbatch: 400 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0128r", superbatch: 400 },
        Some(NetConfig { name: "0128", superbatch: 400 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0128rr", superbatch: 300 },
        Some(NetConfig { name: "0128r", superbatch: 400 }),
    );
}
