...
fn main() {
    // Step 1
    train(
        "/mnt/d/Chess Data/Selfgen/interleaved-plenty1536.data",
        wdl::ConstantWDL { value: 0.5 },
        lr::CosineDecayLR { initial_lr: 0.001, final_lr: 0.001 * 0.3 * 0.3 * 0.3, final_superbatch: 420 },
        NetConfig { name: "0092", superbatch: 420 },
        None,
    );

    // Step 2
    train(
        "/mnt/d/Chess Data/Selfgen/interleaved.data",
        wdl::ConstantWDL { value: 0.6 },
        lr::CosineDecayLR { initial_lr: 0.00025, final_lr: 0.00025 * 0.3 * 0.3 * 0.3, final_superbatch: 320 },
        NetConfig { name: "0092r5", superbatch: 320 },
        Some(NetConfig { name: "0092", superbatch: 420 }),
    );
    ...
    train(
        ...
        wdl::ConstantWDL { value: 0.6 },
        lr::CosineDecayLR { initial_lr: 0.00025, final_lr: 0.00025 * 0.3 * 0.3 * 0.3, final_superbatch: 320 },
        NetConfig { name: "0092r5r", superbatch: 320 },
        Some(NetConfig { name: "0092r5", superbatch: 320 }),
    );
}
