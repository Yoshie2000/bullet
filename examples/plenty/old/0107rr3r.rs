...
fn train<WDL: WdlScheduler, LR: LrScheduler>(
    ...
    trainer.optimiser_mut().graph.get_weights_mut("l0f").gradients = None;
    trainer.optimiser_mut().graph.get_weights_mut("l0w").gradients = None;
    trainer.optimiser_mut().graph.get_weights_mut("l0b").gradients = None;
    trainer.optimiser_mut().graph.get_weights_mut("l1w").gradients = None;
    trainer.optimiser_mut().graph.get_weights_mut("l1b").gradients = None;
    trainer.optimiser_mut().graph.get_weights_mut("l2w").gradients = None;
    trainer.optimiser_mut().graph.get_weights_mut("l2b").gradients = None;
...
fn main() {
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.000025, final_lr: 0.000025 * 0.3 * 0.3 * 0.3, final_superbatch: 100 },
        NetConfig { name: "0107rr3r", superbatch: 100 },
