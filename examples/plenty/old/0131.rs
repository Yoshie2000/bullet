...
fn train<WDL: WdlScheduler, LR: LrScheduler>(
    ...
    trainer.optimiser.set_params(optimiser::RangerParams {
        decay: 0.01, beta1: 0.99, beta2: 0.999, min_weight: -0.99, max_weight: 0.99, alpha: 0.5, k: 6
    });
...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0131", superbatch: 1000 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0131r", superbatch: 400 },
        Some(NetConfig { name: "0131", superbatch: 1000 }),
    );
}
