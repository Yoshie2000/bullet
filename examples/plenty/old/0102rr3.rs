...
use bullet_lib::{
    ...
    }, game::inputs::ChessBucketsMirroredFactorised, lr::{self, LrScheduler}, nn::optimiser, trainer::NetworkTrainer, value::loader::ViriBinpackLoader, wdl::{self, WdlScheduler}, Activation, ExecutionContext, LocalSettings, TrainingSchedule, TrainingSteps
};
...
fn main() {
    // Step 4
    train(
        ViriBinpackLoader::new("/mnt/d/Chess Data/Selfgen/20ksn.viri", 4096, 4, Filter {
            min_ply: 24,
            min_pieces: 3,
            max_eval: 32000,
        ...
        wdl::ConstantWDL { value: 0.75 },
        lr::CosineDecayLR { initial_lr: 0.00025 * 0.3, final_lr: 0.00025 * 0.3 * 0.3 * 0.3 * 0.3, final_superbatch: 200 },
        NetConfig { name: "0102rr3", superbatch: 200 },
