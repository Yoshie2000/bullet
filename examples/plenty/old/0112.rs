...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0112", superbatch: 300 },
        None,
    );
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.001 / 4.0, final_lr: 0.001 / 40.0 * 0.3 * 0.3 * 0.3, final_superbatch: 500 },
        NetConfig { name: "0112r", superbatch: 500 },
        Some(NetConfig { name: "0112", superbatch: 300 }),
    );
}
