...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0111", superbatch: 200 },
        None,
    );
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.00025, final_lr: 0.00025 * 0.3 * 0.3 * 0.3, final_superbatch: 200 },
        NetConfig { name: "0111r", superbatch: 200 },
        Some(NetConfig { name: "0111", superbatch: 200 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0111rr", superbatch: 400 },
        Some(NetConfig { name: "0111r", superbatch: 200 }),
    );
}
