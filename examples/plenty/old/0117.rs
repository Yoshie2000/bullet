...
fn main() {
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.001, final_lr: 0.001 * 0.3 * 0.3 * 0.3, final_superbatch: 100 },
        NetConfig { name: "0117", superbatch: 100 },
        None,
    );
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.00025, final_lr: 0.00025 * 0.3 * 0.3 * 0.3, final_superbatch: 100 },
        NetConfig { name: "0117r", superbatch: 100 },
        Some(NetConfig { name: "0117", superbatch: 100 }),
    );
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.0005, final_lr: 0.00025 * 0.3 * 0.3 * 0.3, final_superbatch: 400 },
        NetConfig { name: "0117rr", superbatch: 400 },
        Some(NetConfig { name: "0117r", superbatch: 100 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0117rrr", superbatch: 400 },
        Some(NetConfig { name: "0117rr", superbatch: 400 }),
    );
}
