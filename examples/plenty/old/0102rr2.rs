...
fn main() {
    // Step 4
    train(
        // ViriBinpackLoader::new("/mnt/d/Chess Data/Selfgen/Data/20ksn.viri", 1024, 4, Filter {
        //     min_ply: 24,
        //     min_pieces: 3,
        //     max_eval: 32000,
        ...
        lr::CosineDecayLR { initial_lr: 0.00025 * 0.3, final_lr: 0.00025 * 0.3 * 0.3 * 0.3 * 0.3, final_superbatch: 100 },
        NetConfig { name: "0102rr2", superbatch: 100 },
