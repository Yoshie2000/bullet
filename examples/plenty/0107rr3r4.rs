...
use bullet_lib::{
    ...
    lr::{self, LrScheduler},
    nn::{optimiser::{self, RangerOptimiser}, InitSettings},
...
fn make_trainer() -> Trainer<RangerOptimiser, ChessBucketsMirrored, MaterialCount<8>> {
    #[rustfmt::skip]
...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0107rr3r4", superbatch: 300 },
