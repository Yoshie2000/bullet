...
fn make_trainer() -> ValueTrainer<AdamW<CudaDevice>, ThreatInputsBucketsMirrored, MaterialCount<8>> {
    ...
    return ValueTrainerBuilder::default()
        ...
        .loss_fn(|output, targets| {
            ...
            let factor = is_greater * 1.15 + (1.0 - is_greater) * 1.0;
...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0154", superbatch: 1000 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0154r", superbatch: 400 },
        Some(NetConfig { name: "0154", superbatch: 1000 }),
    );
}
