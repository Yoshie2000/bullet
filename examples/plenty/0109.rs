...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0109", superbatch: 300 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0109r", superbatch: 300 },
        Some(NetConfig { name: "0109", superbatch: 300 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0109rr", superbatch: 400 },
        Some(NetConfig { name: "0109r", superbatch: 300 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0109rrr", superbatch: 300 },
