...
fn train<WDL: WdlScheduler, LR: LrScheduler>(
    ...
    trainer.optimiser.set_params_for_weight("l0f", optimiser::AdamWParams {
        decay: 0.01,
        beta1: 0.9,
        beta2: 0.999,
        min_weight: -0.99 * 0.5,
...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0114", superbatch: 300 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0114r", superbatch: 300 },
        Some(NetConfig { name: "0114", superbatch: 300 }),
    );
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.00025, final_lr: 0.00025 * 0.3 * 0.3 * 0.3, final_superbatch: 300 },
        NetConfig { name: "0114rr", superbatch: 300 },
        Some(NetConfig { name: "0114r", superbatch: 300 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0114rrr", superbatch: 300 },
        Some(NetConfig { name: "0114rr", superbatch: 300 }),
    );
}
