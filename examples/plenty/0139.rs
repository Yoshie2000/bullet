...
fn main() {
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.001, final_lr: 0.001 * 0.3 * 0.3 * 0.3, final_superbatch: 700 },
        NetConfig { name: "0139", superbatch: 700 },
        None,
    );
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.000025, final_lr: 0.000025 * 0.3 * 0.3 * 0.3, final_superbatch: 700 },
        NetConfig { name: "0139r", superbatch: 700 },
        Some(NetConfig { name: "0139", superbatch: 700 }),
    );
}
