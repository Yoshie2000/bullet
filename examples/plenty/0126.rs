...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0126", superbatch: 300 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0126r", superbatch: 300 },
        Some(NetConfig { name: "0126", superbatch: 300 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0126rr", superbatch: 400 },
        Some(NetConfig { name: "0126r", superbatch: 300 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0126rrr", superbatch: 300 },
