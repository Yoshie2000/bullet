...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0119", superbatch: 400 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0119r", superbatch: 400 },
        Some(NetConfig { name: "0119", superbatch: 400 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0119rr", superbatch: 300 },
        Some(NetConfig { name: "0119r", superbatch: 400 }),
    );
}
