...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0118", superbatch: 300 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0118r", superbatch: 300 },
        Some(NetConfig { name: "0118", superbatch: 300 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0118rr", superbatch: 400 },
        Some(NetConfig { name: "0118r", superbatch: 300 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0118rrr", superbatch: 300 },
        Some(NetConfig { name: "0118rr", superbatch: 400 }),
    );
}
