...
fn main() {
    train(
        ...
        wdl::Sequence {
            ...
            first_scheduler_final_superbatch: 1000,
            second: wdl::ConstantWDL { value: 1.0 },
        },
        lr::Sequence {
            first: lr::CosineDecayLR { initial_lr: 0.001, final_lr: 0.001 * 0.3 * 0.3 * 0.3, final_superbatch: 1000 },
            first_scheduler_final_superbatch: 1000,
            second: lr::CosineDecayLR { initial_lr: 0.000025, final_lr: 0.000025 * 0.3 * 0.3 * 0.3, final_superbatch: 400 },
        },
        NetConfig { name: "0140", superbatch: 1400 },
        None,
    );
}
