...
fn main() {
    // Step 2
    train(
        "/mnt/e/Chess/Data/combined-0146r.vf",
        wdl::ConstantWDL { value: 1.0 },
        lr::LinearDecayLR { initial_lr: 0.000025, final_lr: 0.000025 * 0.3 * 0.3 * 0.3, final_superbatch: 400 },
        NetConfig { name: "0134-2r11", superbatch: 400 },
