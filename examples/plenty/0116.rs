...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0116", superbatch: 200 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0116r", superbatch: 100 },
        Some(NetConfig { name: "0116", superbatch: 200 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0116rr", superbatch: 300 },
        Some(NetConfig { name: "0116r", superbatch: 100 }),
    );
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.000025, final_lr: 0.000025 * 0.3 * 0.3 * 0.3, final_superbatch: 200 },
        NetConfig { name: "0116rrr", superbatch: 200 },
        Some(NetConfig { name: "0116rr", superbatch: 300 }),
    );
}
