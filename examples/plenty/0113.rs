...
fn make_trainer() -> ValueTrainer<AdamW<ExecutionContext>, ChessBucketsMirrored, MaterialCount<8>> {
    ...
    return ValueTrainerBuilder::default()
        ...
        .build(|builder, stm, ntm, buckets| {
            ...
            let l3 = builder.new_affine("l3", 2 * L3_SIZE + 2 * L2_SIZE, OUTPUT_BUCKETS);
            ...
            // L2 dual activation
            let l2_out = l2.forward(l1_out).select(buckets);
            let l2_out = l2_out.concat(l2_out.abs_pow(2.0));
...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0113", superbatch: 300 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0113r", superbatch: 300 },
        Some(NetConfig { name: "0113", superbatch: 300 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0113rr", superbatch: 400 },
        Some(NetConfig { name: "0113r", superbatch: 300 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0113rrr", superbatch: 300 },
        Some(NetConfig { name: "0113rr", superbatch: 400 }),
    );
}
