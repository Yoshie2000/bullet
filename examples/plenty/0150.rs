...
fn main() {
    ...
    train(
        ...
        lr::CosineDecayLR { initial_lr: 0.001, final_lr: 0.001 * 0.3 * 0.3 * 0.3, final_superbatch: 250 },
        NetConfig { name: "0150", superbatch: 250 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0150r", superbatch: 100 },
        Some(NetConfig { name: "0150", superbatch: 250 }),
    );
}
