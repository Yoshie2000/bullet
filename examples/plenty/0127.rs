...
fn main() {
    ...
    train(
        ...
        NetConfig { name: "0127", superbatch: 400 },
        None,
    );
    ...
    train(
        ...
        NetConfig { name: "0127r", superbatch: 400 },
        Some(NetConfig { name: "0127", superbatch: 400 }),
    );
    ...
    train(
        ...
        NetConfig { name: "0127rr", superbatch: 300 },
        Some(NetConfig { name: "0127r", superbatch: 400 }),
    );
}
